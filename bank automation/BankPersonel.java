...
public class BankPersonel extends User {
   public int salary;
  ...
  public BankPersonel(String id) {
   ...
   void login(String id, String password) {
          ...
          Statement stmt=conn.createStatement();
           String logincontrol="Select * from bank.bankpersonel where personel_id='"+id+"' AND password='"+password+"'";
    ...
    void register(String id, String name, String password, String phone) {
        ...
        String position=this.getPosition();
          ...
          stmt.execute("INSERT INTO bank.bankpersonel VALUES('"+id+"','"+name+"','"+password+"','"+phone+"',0,750,"+salary+",'"+province+"','"+position+"')");
           JOptionPane.showMessageDialog(null,name+" Başarıyla kayıt olundu.Personel id'niz:"+id);
            ...
            if(rs.next()){
             ...
             int balance=rs.getInt(5);
              ...
              if(amount<=balance){
               ...
               stmt.execute("UPDATE bank.bankpersonel SET balance="+balance+" ");       
              }
              else{
                  if((balance+addbalance)<amount){
                      ...
                      balance=0;        
                      addbalance-=amount;
                     stmt.execute("UPDATE bank.bankpersonel SET balance="+balance+",addbalance="+addbalance+" ");
                  }
              }
            }
            else{
    ...
    public void moneydeposit(String id) {
          ...
          if(rs.next()){
            ...
            JOptionPane.showMessageDialog(null,amount+"Hesabınıza eklendi");
              ...
              JOptionPane.showMessageDialog(null,"PERSONEL İD HATALI.SİSTEMİMİZDE KAYITLI BÖYLE BİR İD BULUNMAMAKTADIR.LÜTFEN KONTROL EDİNİZ");
               personeloperations pop=new personeloperations();
            pop.setVisible(true);
          }
        }catch(Exception e){
    ...
    public void changepin(String id) {
          ...
          if(rs.next()){
             ...
             String input=JOptionPane.showInputDialog("Mevcut şifrenizi giriniz");
              ...
              stmt.execute("UPDATE bank.bankpersonel SET password='"+newpassword+"' ");
              JOptionPane.showMessageDialog(null,"ŞİFRENİZ DEĞİŞTİRİLDİ");
              }  
          }
          else{
              JOptionPane.showMessageDialog(null, "PERSONEL İDS'Sİ HATALI.SİSTEMİMİZDE KAYITLI BÖYLE BİR İD BULUNMAMAKTADIR.LÜTFEN KONTROL EDİNİZ");
             personeloperations pop=new personeloperations();
             pop.setVisible(true);
          } 
       }catch(Exception e){
